  ...
  const handleAddSupplier = async (e: React.FormEvent) => {
    ...
    if (!newSupplier.category) {
      toast({
        ...
        description: "Please select a category for the supplier",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      await addSupplier({
        ...
        icazNumber: '', // Auto-generated by database trigger
      ...
      setNewSupplier({ name: '', contactInfo: '', category: '' as SupplierCategory });
            ...
            <form onSubmit={handleAddSupplier} className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> ICAZ numbers are auto-generated (ICAZ_001, ICAZ_002, etc.)
                </p>
              </div>

              <div className="space-y-2">
                <Label htmlFor="supplierCategory">Category *</Label>
                <Select value={newSupplier.category} onValueChange={(value) => setNewSupplier({ ...newSupplier, category: value as SupplierCategory })}>
